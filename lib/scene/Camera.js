...
export default function Camera($screen, focusPlane, options) {
...
Camera.prototype.update = function () {
    ...
    if (this.typeOfFocus === FOCUS_TYPE.LARGEST) {
        let xRatio = (this.focusPlane.x / screenDimensions.width);
        let yRatio = (this.focusPlane.y / screenDimensions.height);
...
Camera.prototype.getRestrictToFocusZ = function (movement = vector.origin) {
...
Camera.prototype.getRestrictToFocusXY = function (movement = vector.origin) {
